...
JOBS: list[ExtractJob] = [
    ExtractJob("frs",  1994, "frs/1994",     "--frs"),
    ExtractJob("frs",  1995, "frs/1995",     "--frs"),
    ExtractJob("frs",  1996, "frs/1996",     "--frs"),
    ExtractJob("frs",  1997, "frs/1997",     "--frs"),
    ExtractJob("frs",  1998, "frs/1998",     "--frs"),
    ExtractJob("frs",  1999, "frs/1999",     "--frs"),
    ExtractJob("frs",  2000, "frs/2000",     "--frs"),
    ExtractJob("frs",  2001, "frs/2001",     "--frs"),
    ExtractJob("frs",  2002, "frs/2002",     "--frs"),
    ExtractJob("frs",  2003, "frs/2003",     "--frs"),
    ExtractJob("frs",  2004, "frs/2004",     "--frs"),
    ExtractJob("frs",  2005, "frs/2005",     "--frs"),
    ExtractJob("frs",  2006, "frs/2006",     "--frs"),
    ExtractJob("frs",  2007, "frs/2007",     "--frs"),
    ExtractJob("frs",  2008, "frs/2008",     "--frs"),
    ExtractJob("frs",  2009, "frs/2009",     "--frs"),
    ExtractJob("frs",  2010, "frs/2010",     "--frs"),
    ExtractJob("frs",  2011, "frs/2011",     "--frs"),
    ExtractJob("frs",  2012, "frs/2012",     "--frs"),
    ExtractJob("frs",  2013, "frs/2013",     "--frs"),
    ExtractJob("frs",  2014, "frs/2014",     "--frs"),
    ExtractJob("frs",  2015, "frs/2015",     "--frs"),
    ExtractJob("frs",  2016, "frs/2016",     "--frs"),
    ExtractJob("frs",  2017, "frs/2017",     "--frs"),
    ExtractJob("frs",  2018, "frs/2018",     "--frs"),
    ExtractJob("frs",  2019, "frs/2019",     "--frs"),
    ExtractJob("frs",  2020, "frs/2020",     "--frs"),
    ExtractJob("frs",  2021, "frs/2021",     "--frs"),
